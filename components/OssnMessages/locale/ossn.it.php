...
$en = array(
	...
	'ossnmessages:delete:all:note' => "Rimuoverai permanentemente questo messaggio per l'altro membro. L'altro membro potr� vedere che hai rimosso un messaggio.",
	
	'ossnmessages:delete:me' => 'Togliere per voi',
	'ossnmessages:delete:me:note' => "Questo messaggio sar� rimosso per voi. L'altro membro sar� ancora in grado di vederlo.",
